...
import './Aramex.css'// Worker import for pdf.js

const AremexInvoices=()=>{
  ...
  const extractInvoiceNumber = (text) => {
    const regexList = [/Invoice No:\s*([A-Z0-9-]+)/i]; // Fedex ka regex
  ...
  const handleFiles = async (files) => {
    ...
    saveAs(zipData, "Aremax_Invoices.zip");
  ...
  return (
    <div className="section">
      <h2 className="section-header"><span>📭</span> Aramex Invoice PDF Renamer</h2>
      <small>Upload Aramex invoice PDFs.</small>
